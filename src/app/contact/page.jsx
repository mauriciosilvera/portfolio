...
function Contact() {
  ...
  if (sended) {
    return (
      <section className="w-11/12 mb-5 py-10 rounded-xl dark:bg-boxes flex flex-wrap items-center justify-center flex-col shadow-md shadow-boxes sm:w-4/5 order-3 lg:w-11/12 lg:mb-0">
  ...
  return (
    <section className="w-11/12 sm:w-4/5 mb-5 rounded-xl dark:bg-boxes flex flex-wrap items-center justify-center flex-col shadow-md shadow-boxes order-3 lg:w-11/12 lg:justify-start lg:mb-0">
      ...
      >
        ...
        <button
          type="submit"
          className="p-4 mb-4 self-center rounded-xl text-lg font-medium dark:bg-turquoise dark:hover:bg-emerald-600"
        >
          {contact.buttonLabel}
        </button>
      </motion.form>
